    ...
    caps: {
      ...
      items: [
        ...
        },
        {
          tag: '03',
          name: 'العلب',
          desc: 'يتوفر لدينا قسم خاص بتصنيع العلب من الهارد كفر والفوركس والأكريليك مع الطباعة.',
          specs: ['هارد كفر', 'فوركس وأكريليك', 'تصنيع وطباعة'],
        },
        {
          tag: '04',
          name: 'الأكياس الورقية',
          desc: 'طباعة جميع الأكياس الورقية للمطاعم والكافيهات بكل المقاسات، بمقبض أو بدون، بحبر صديق للبيئة.',
          specs: ['كل المقاسات', 'بمقبض أو بدون', 'حبر صديق للبيئة'],
        },
        {
          tag: '05',
          name: 'الستيكرات والليبلات',
          desc: 'طباعة جميع أنواع الستيكرات البلاستيك والورق، وستيكر الرول الخاص بالتمور والمنتجات بكل الأشكال، وليبلات قماش للخياطين.',
          specs: ['بلاستيك وورق', 'ستيكر رول', 'ليبلات قماش'],
        },
        {
          tag: '06',
          name: 'المعارض والمناسبات',
          desc: 'يتوفر لدينا قسم خاص بتنفيذ الفعاليات والمهرجانات والمعارض وأسوار المشاريع الخشبية وكل ما يلزم المناسبات.',
          specs: ['فعاليات ومهرجانات', 'أسوار مشاريع', 'تجهيز كامل'],
        },
        {
          tag: '07',
          name: 'اللوحات المضيئة والإرشادية',
          desc: 'تنفيذ جميع اللوحات المضيئة الخارجية والداخلية، وتصنيع مجسمات الحديد، واللوحات الإرشادية للمشاريع والطرق.',
          specs: ['مضيئة داخلي وخارجي', 'مجسمات حديد', 'لوحات إرشادية'],
        },
        {
          tag: '08',
          name: 'الهدايا الدعائية',
          desc: 'قسم خاص للهدايا الدعائية من بوكسات هدايا وفلاشات وأجندات وأكواب، وطباعة التيشيرتات وتطريزها.',
          specs: ['بوكسات وفلاشات', 'أجندات وأكواب', 'طباعة وتطريز'],
        },
        {
          tag: '09',
          name: 'استشارات الطباعة',
          desc: 'قسم خاص بالاستفسارات الخاصة بالطباعة، نساعدك للوصول إلى الحل الأنسب الذي يخدم منتجك.',
          specs: ['استشارة مجانية', 'حلول مخصصة', 'دعم مباشر'],
        },
        {
          tag: '10',
          name: 'طباعة وتغليف الكتب',
          desc: 'يوجد لدينا قسم خاص بطباعة الكتب والروايات والمجلات مع التغليف.',
          specs: ['كتب وروايات', 'مجلات', 'تغليف'],
        },
        {
          tag: '11',
          name: 'قسم المواليد',
          desc: 'يتوفر لدينا قسم خاص بالمواليد والمناسبات الأسرية من ستاندات فوركس وكروت طاولة ودعوات تهنئة.',
          specs: ['ستاندات فوركس', 'كروت طاولة', 'دعوات تهنئة'],
        },
        {
          tag: '12',
          name: 'مشاريع التخرج',
          desc: 'يتوفر لدينا قسم خاص لتصنيع مشاريع التخرج من الفوركس والأكريليك.',
          specs: ['فوركس', 'أكريليك', 'تنفيذ حسب الطلب'],
        },
      ],
    },
